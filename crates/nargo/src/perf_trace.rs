...
pub mod inner {
    ...
    macro_rules! start_timer {
        ($msg:expr) => {{
            use $crate::perf_trace::inner::{
                compute_indent, AtomicUsize, Instant, Ordering, ToString, NUM_INDENT, PAD_CHAR,
            };
            ...
            $crate::perf_trace::TimerInfo { msg: msg.to_string(), time: Instant::now() }
        }};
    }
    ...
    macro_rules! end_timer {
        ...
        ($time:expr, $msg:expr) => {{
            use $crate::perf_trace::inner::{
                compute_indent, format, AtomicUsize, Instant, Ordering, ToString, NUM_INDENT,
                PAD_CHAR,
            };
    ...
    macro_rules! add_to_trace {
        ($title:expr, $msg:expr) => {{
            use $crate::perf_trace::{
                compute_indent, compute_indent_whitespace, format, AtomicUsize, Instant, Ordering,
                ToString, NUM_INDENT, PAD_CHAR,
            };
